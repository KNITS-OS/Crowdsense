...
export type AlertType = ReactNode | null;
...
export type IKNCareerStatus =
  | "New"
  | "Closed"
  | "In Review"
  | "Declined By Candidate"
  | "Declined By Reviewer";
export type IKNCareerCurriculumStatus =
  | "CV Review"
  | "CV Reviewed"
  | "Ready for interview";
...
export type ISimpleFilter = "eq" | "neq" | "gt" | "gte" | "lt" | "lte" | "is";
